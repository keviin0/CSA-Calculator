...
|Siddhant Ranka   | 18/20  |I made large contributions to the README, especially much more than I had set as a goal. I also added extra notes to my part of the Study Journal to document my learning https://docs.google.com/document/d/1Eq7m4VV92lnr9jNV4NAeMXk2w12HXQcJsRfXPjjd0Jk/edit. However, I fell short of my plans for my code, which is why I get 2 points taken off. On Monday and Tuesday, before I was assigned my part, I created a code for a deck of cards. Kevin's worked better, so I commented my work out, but independently, I was able to fix my card deck to become functional and I was making progress on shuffling it. I was then assigned to work on the view for the UNO grame. I had far more difficulty learning the necessary code than I thought and I had rubber chickens in my attempt to make a deck button. If the scrum master allows it, I would like to switch to working on the actual text next week since I am far more familiar with that code. Code Links: https://github.com/keviin0/CSA-Portfolio-GroceryStoreSim/commit/b0948371051e5d30ab8f758969001822f3ab8179, https://github.com/keviin0/CSA-Portfolio-GroceryStoreSim/commit/0939cbe3031c39a298ad15b24981f6041ccf5f47  |   |
|   |   |   |   |
