...
/* Javax.swing.* is used to create JFrames. Java.awt.* is used to create labels/buttons.
...
public class TicTacToe extends JPanel
{
    ...
    /* A list of buttons is created. When clicked, they can change array values in board[].
    This will be used to see if someone won or if a draw occurred. */
    ...
    If the player won or a draw occurred, the label on the window is updated to show it. */
    ...
    /* In this function, the board array is used to see if there is a winner or if a draw occurred.
    If both of these conditions are false, the game continues. */
    ...
    /* In this function, buttons are created for the player to put his/her/their turns in.
    Every time a player clicks on an applicable button, the board array is updated. */
